	...
	else
	{
		...
		if(statdir.SetInitDir(inputpath))
		{
			...
			for(vector<string>::const_iterator it = file_vec.begin(); it < file_vec.end(); ++it)  
			{
				...
				if((s.find("2015-")!=-1 || s.find("2016-")) && s.find("W8-")!=-1 && s.find(angle)!=-1 && s.find(".png")!=-1 && s.find("W8_")!=-1)
				{
					...
					if (s.find("2015-")!=-1)
					{
						s1=s.substr(s.find("2015-"), 10);
					}
					else if(s.find("2016-")!=-1)
					{
						s1=s.substr(s.find("2016-"), 10);
					}
					s2=s.substr(s.find("W8-"), 9);
					if (s.find("2015-")!=-1)
					{
						s3=s.substr(s.find("2015-")+11, 8);
					}
					else if(s.find("2016-")!=-1)
					{
						s3=s.substr(s.find("2016-")+11, 8);
					}
					...
					fp=fopen(fname, "a");
					fprintf(fp, "%s, %s, %s,", s2, s1, s3);

					if(strcmp(inputpath, "Y:\\lemnatec_png\\2015-04-27")==0)//height file
					{
						f1=outputpath;
						f1.append("\\");
						f1.append(s2);
						f1.append(".txt");
						char* fname1=new char[f1.length()+1];
						strcpy(fname1, f1.c_str());
						fp1=fopen(fname1, "w");
					}
					if(strcmp(inputpath, "Y:\\lemnatec_png\\2015-04-27")==0)//height file
					{
						f1=outputpath;
						f1.append("\\");
						f1.append("carsize.txt");
						char* fname1=new char[f1.length()+1];
						strcpy(fname1, f1.c_str());
						fp2=fopen(fname1, "w");
					}
					if(strcmp(inputpath, "Y:\\lemnatec_png\\2015-04-01")==0)//height file
					{
						f1=outputpath;
						f1.append("\\");
						f1.append("carsize.txt");
